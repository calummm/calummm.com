...
const enemyList = Array.from(level.getElementsByClassName('enemy')).map(
	(enemyEl) => {
		const enemyDiv = enemyEl;
		const enemyComp = window.getComputedStyle(enemyDiv);
